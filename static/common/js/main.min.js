...
panels=a.children("li"),tabs=$(".tabbed-list-view-nav a"),tabWidth=tabs.first().width(),

arrow=$(".tabbed-list-view-nav-arrow"),ww=panels.first().width();
arrow.css({left:tabWidth/2});

$.each(panels,function(){$(this).css({left:(panels.index(this)*ww)+"px"});});
tabs.click(function(c){c.preventDefault();$(tabs).removeClass("on");
